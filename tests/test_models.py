...
class TestEnterpriseCustomerCatalog(unittest.TestCase):
    ...
    def test_get_content_filter(self):
        ...
        of its own if there is not `EnterpriseCatalogQuery` is linked to it. If there is a linked
        `EnterpriseCatalogQuery` then it should return content filter of linke `EnterpriseCatalogQuery`.
        """
